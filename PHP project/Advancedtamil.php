    ...
    <div class="maintable">
      ...
      <tbody>
	   		<?php
				...
				$query="select * from studentdetails where Nme='AdvancedTamil' ORDER BY department ASC,deptno ASC ";
				...
				{
					echo "<centr><h1>NO Such Data</h1></center>";
				}
				echo "<center><h1>AdvancedTamil</h1></center>";
				?>
			</tbody>
	</table>
    </div>
