    ...
    <div class="maintable">
      ...
      <tbody>
	   		<?php
				...
				$query="select * from studentdetails where Nme='B.Com.(General)'ORDER BY department ASC,deptno ASC";
				...
				echo "<center><h1>B.Com.(General)</h1></center>";
				?>
			</tbody>
	</table>
    </div>
